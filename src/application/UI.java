...
public class UI 
{
	...
	public static void printMatch(ChessMatch chessMatch, List <ChessPiece> captured)
	{
		...
		//if para testar se deu cheque mate ou não 
		if(!chessMatch.getCheckMate())
		{
			//Caso não deu cheque mate continua
			System.out.println("Waiting player: "+ chessMatch.getCurrentPlayer());
			if(chessMatch.getCheck() )
			{
				//Esse if testa se a peça esta em cheque, mostra a menssagem abaixo
	...
	{
		/*Função para listar todos as peças capturadas do adversario*/
		...
		System.out.println(Arrays.toString(white.toArray())); //é uma maneira de imprimir um array
		System.out.print(ANSI_RESET);
